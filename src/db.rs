...
pub trait Modules: Sources {
  fn module_ast(&self, file_path: String) -> Result<crate::ast::UntypedModule, crate::error::Error>;
...
pub fn module_ast(db: &impl Modules, file_path: String) -> Result<crate::ast::UntypedModule, crate::error::Error> {
